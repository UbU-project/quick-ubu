...
- `--ollama-total-timeout` (default **1200 seconds**) limits the entire request,
...
```sh
cargo run -- advise --ollama-timeout 300 --ollama-total-timeout 1200
cargo run -- replan --planner ollama --ollama-timeout 300 --ollama-total-timeout 1200
```
